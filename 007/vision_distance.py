...
class vision_depth:
    def __init__(self):
        # Loading Mask RCNN
        self.net = cv2.dnn.readNetFromTensorflow("MODEL/visdepth/frozen_inference_graph_coco.pb",
                                            "MODEL/visdepth/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt")
        ...
        self.classes = []
        with open("MODEL/visdepth/classes.txt", "r") as file_object:
